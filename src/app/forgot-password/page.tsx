...
export default function ForgotPasswordPage() {
        ...
        return (
            ...
            >
                <div className="flex flex-col items-center gap-6 py-4">
                    <div className="w-16 h-16 bg-emerald-100 dark:bg-emerald-900/30 rounded-full flex items-center justify-center animate-bounce-slow">
                    ...
                    <Link 
                        href="/login" 
                        className="w-full bg-primary text-white font-bold py-3.5 rounded-xl flex items-center justify-center gap-2 hover:bg-emerald-700 transition-all active:scale-[0.98]"
                    >
                        Kembali ke Login
                    </Link>
                </div>
    ...
    return (
        ...
        >
            <form onSubmit={handleResetPassword} className="w-full flex flex-col gap-6">
                ...
                >
                    {isLoading ? (
                        ...
                        <><Mail className="w-4 h-4" /> Kirim Link Pemulihan</>
                    )}
                </button>
            </form>
            ...
            <Link
                href="/login"
                className="mt-8 text-xs font-bold text-muted-foreground hover:text-primary transition-colors flex items-center gap-2"
            >
