...
import { Leaf, ArrowLeft, Mail, Lock, UserPlus, LogIn } from "lucide-react";
    ...
    return (
        <div className="min-h-screen w-full bg-background flex items-center justify-center relative overflow-hidden font-sans text-foreground">
            ...
            <div className="relative z-10 w-full max-w-[420px] p-8">
                <div className="bg-white/80 dark:bg-gray-900/60 backdrop-blur-xl p-8 rounded-[32px] shadow-[0_20px_60px_rgba(0,0,0,0.04)] border border-white/20 dark:border-white/5 flex flex-col items-center">
                    ...
                    <form onSubmit={handleEmailAuth} className="w-full flex flex-col gap-4 mb-6">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-primary text-white font-bold py-3.5 rounded-xl flex items-center justify-center gap-2 hover:bg-emerald-700 transition-all active:scale-[0.98] disabled:opacity-50"
                        >
                            {isLoading ? (
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className={`w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 font-bold py-3 px-4 rounded-xl flex items-center justify-center gap-3 transition-all ${isLoading ? 'opacity-70 cursor-not-allowed' : 'hover:bg-gray-50 dark:hover:bg-gray-700 hover:shadow-sm active:scale-[0.98]'
                            }`}
                    >
