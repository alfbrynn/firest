...
export default function LandingPage() {
  return (
    <div className="min-h-screen w-full bg-background relative overflow-hidden font-sans text-foreground">
      ...
      <header className="fixed top-0 left-0 z-50 w-full border-b border-gray-100/50 dark:border-gray-800/50 bg-white/80 dark:bg-gray-950/80 backdrop-blur-md">
        <nav className="max-w-[1800px] mx-auto px-8 sm:px-16 lg:px-24 xl:px-32 2xl:px-40 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-3">
            <Link
              href="/login"
              className="text-sm font-bold text-white bg-primary hover:bg-emerald-700 hover:shadow-md hover:-translate-y-0.5 active:translate-y-0 transition-all px-5 py-2.5 rounded-xl shadow-xs"
            >
              Masuk
            </Link>
          </div>
      ...
      {/* Hero Section */}
      <main className="relative z-10 max-w-[1800px] mx-auto px-8 sm:px-16 lg:px-24 xl:px-32 2xl:px-40 pt-28 pb-20 lg:pt-36 lg:pb-24 flex flex-col lg:flex-row items-center gap-12 lg:gap-32 xl:gap-48">
        ...
        <div className="flex-1 text-center lg:text-left w-full">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-8">
            ...
            <Link
              href="/login"
              className="inline-flex items-center justify-center gap-3 bg-slate-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-foreground px-8 py-4 rounded-2xl font-bold text-lg hover:bg-slate-100 dark:hover:bg-gray-800 hover:-translate-y-1 transition-all active:scale-95 w-full sm:w-auto"
            >
              Mulai Petualangan
            </Link>
          </div>
      ...
      {/* 3 Langkah Fitur */}
      <section className="relative z-10 max-w-[1800px] mx-auto px-8 sm:px-16 lg:px-24 xl:px-32 2xl:px-40 pb-24">
      ...
      <section className="relative z-10 max-w-[1800px] mx-auto px-8 sm:px-16 lg:px-24 xl:px-32 2xl:px-40 pb-24">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-black text-foreground tracking-tight mb-4">Kenapa Cara Lama Selalu Gagal?</h2>
          <p className="text-muted-foreground max-w-xl mx-auto text-sm sm:text-base">Mencatat keuangan tidak harus membosankan seperti mengisi tabel akuntansi yang kaku.</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          {/* Sisi Kiri: Cara Lama */}
          <div className="bg-rose-50/20 dark:bg-rose-950/5 border border-rose-500/10 rounded-[32px] p-8 sm:p-10 flex flex-col justify-between">
            <div>
              <div className="w-12 h-12 bg-rose-100 dark:bg-rose-900/30 rounded-2xl flex items-center justify-center mb-6">
                <ShieldAlert className="w-6 h-6 text-rose-600 dark:text-rose-400" />
              </div>
              <h3 className="text-2xl font-black text-rose-950 dark:text-rose-200 mb-6">Pencatatan Konvensional</h3>
            ...
            <div className="mt-8 pt-6 border-t border-rose-500/5 text-xs font-bold text-rose-600 uppercase tracking-widest">
              Hasil: Tabungan Selalu Habis
            </div>
          </div>

          {/* Sisi Kanan: Cara Firest */}
          <div className="bg-emerald-50/20 dark:bg-emerald-950/5 border border-emerald-500/10 rounded-[32px] p-8 sm:p-10 flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-2xl font-black text-emerald-950 dark:text-emerald-250 mb-6">Ekosistem Firest</h3>
              <ul className="space-y-4">
                <li className="flex gap-3 text-sm sm:text-base text-muted-foreground leading-relaxed">
            ...
            <div className="mt-8 pt-6 border-t border-emerald-500/5 text-xs font-bold text-emerald-600 uppercase tracking-widest">
      ...
      <section className="relative z-10 max-w-[1800px] mx-auto px-8 sm:px-16 lg:px-24 xl:px-32 2xl:px-40 pb-24">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-black text-foreground tracking-tight mb-4">Evolusi Financial Rainforest Anda</h2>
          <p className="text-muted-foreground max-w-xl mx-auto text-sm sm:text-base">Makin tinggi tingkat disiplin menabungmu, makin rimbun ekosistem hutan yang mekar di layar HP-mu.</p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Level 1-2 */}
          <div className="bg-white/40 dark:bg-gray-900/40 backdrop-blur-md border border-gray-100 dark:border-gray-800 rounded-3xl p-6 relative overflow-hidden group">
            <div className="absolute top-[-10%] right-[-10%] w-24 h-24 bg-linear-to-br from-blue-400/10 to-transparent rounded-full blur-xl group-hover:scale-125 transition-all"></div>
            <span className="inline-block px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-[10px] font-bold rounded-lg uppercase tracking-wider mb-4">Benih Impian</span>
            <h4 className="text-xl font-bold text-foreground mb-2">Seedling & Sprout</h4>
            <p className="text-xs text-muted-foreground mb-4 font-bold uppercase tracking-wider">Level 1 - 4</p>
            <p className="text-sm text-muted-foreground leading-relaxed">Tahap awal menabung. Hutan virtual Anda berupa tanah lapang dengan bibit kecil. Anda harus membatasi pengeluaran agar bibit tidak layu.</p>
          </div>

          {/* Level 5-8 */}
          <div className="bg-white/40 dark:bg-gray-900/40 backdrop-blur-md border border-gray-100 dark:border-gray-800 rounded-3xl p-6 relative overflow-hidden group">
            <div className="absolute top-[-10%] right-[-10%] w-24 h-24 bg-linear-to-br from-emerald-400/10 to-transparent rounded-full blur-xl group-hover:scale-125 transition-all"></div>
            <span className="inline-block px-3 py-1 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 text-[10px] font-bold rounded-lg uppercase tracking-wider mb-4">Taman Bersemi</span>
            <h4 className="text-xl font-bold text-foreground mb-2">Sapling & Forest</h4>
            <p className="text-xs text-muted-foreground mb-4 font-bold uppercase tracking-wider">Level 5 - 8</p>
            <p className="text-sm text-muted-foreground leading-relaxed">Tunas tumbuh menjadi pohon rindang. Kupu-kupu, lebah madu, dan kelinci kecil mulai berdatangan meramaikan taman virtual Anda.</p>
          </div>

          {/* Level 9-12 */}
          <div className="bg-white/40 dark:bg-gray-900/40 backdrop-blur-md border border-gray-100 dark:border-gray-800 rounded-3xl p-6 relative overflow-hidden group">
            <div className="absolute top-[-10%] right-[-10%] w-24 h-24 bg-linear-to-br from-orange-400/10 to-transparent rounded-full blur-xl group-hover:scale-125 transition-all"></div>
            <span className="inline-block px-3 py-1 bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 text-[10px] font-bold rounded-lg uppercase tracking-wider mb-4">Rimbar Raya Lestari</span>
            <h4 className="text-xl font-bold text-foreground mb-2">Rainforest & Ecosystem</h4>
            <p className="text-xs text-muted-foreground mb-4 font-bold uppercase tracking-wider">Level 9 - 12</p>
            <p className="text-sm text-muted-foreground leading-relaxed">Ekosistem hutan tropis raksasa yang makmur. Burung warna-warni hinggap di dahan besar. Selamat, kondisi keuangan Anda sudah mandiri!</p>
          </div>
        </div>
      </section>
      ...
      <section className="relative z-10 max-w-[1800px] mx-auto px-8 sm:px-16 lg:px-24 xl:px-32 2xl:px-40 pb-24">
        <div className="bg-gray-50 dark:bg-gray-900/30 border border-gray-100 dark:border-gray-850 rounded-[40px] p-8 sm:p-12 lg:p-16 flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1">
            <div className="w-12 h-12 bg-emerald-100 dark:bg-emerald-900/30 rounded-2xl flex items-center justify-center mb-6">
              <Compass className="w-6 h-6 text-primary" />
            </div>
            <h3 className="text-3xl font-black text-foreground mb-6">Teknologi Hibrida yang Super Ringan & Privat</h3>
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <p className="text-sm text-foreground font-medium"><strong className="font-bold">Regex Parser Instan:</strong> Mesin parsing email kami memproses notifikasi bank secara instan (0.01 detik) langsung di browser Anda.</p>
              </div>
              <div className="flex gap-3">
                <CheckCircle2 className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                <p className="text-sm text-foreground font-medium"><strong className="font-bold">Supabase Row-Level Security (RLS):</strong> Akses data terkunci rapat. Pengguna lain sama sekali tidak dapat mengintip riwayat keuangan Anda.</p>
              </div>
            </div>
          </div>
          <div className="flex-1 w-full grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white dark:bg-gray-900 rounded-3xl p-6 border border-gray-100 dark:border-gray-850 shadow-xs">
              <Landmark className="w-8 h-8 text-blue-500 mb-4" />
              <h5 className="font-bold text-foreground text-base mb-1">Akses Read-Only</h5>
              <p className="text-xs text-muted-foreground leading-relaxed">Akses Gmail opsional kami hanya mendeteksi email tanda terima digital, tidak bisa mengirim email atau merusak akun Anda.</p>
            </div>
            <div className="bg-white dark:bg-gray-900 rounded-3xl p-6 border border-gray-100 dark:border-gray-850 shadow-xs">
              <Trophy className="w-8 h-8 text-amber-500 mb-4" />
              <h5 className="font-bold text-foreground text-base mb-1">Fokus North Star</h5>
              <p className="text-xs text-muted-foreground leading-relaxed">Menghapus kerumitan banyak target. Dengan fokus pada satu impian tunggal, motivasi Anda meningkat hingga 200%.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative z-10 max-w-[1800px] mx-auto px-8 sm:px-16 lg:px-24 xl:px-32 2xl:px-40 pb-24">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-black text-foreground tracking-tight mb-4">Pertanyaan yang Sering Diajukan</h2>
          <p className="text-muted-foreground max-w-xl mx-auto text-sm sm:text-base">Mengenal lebih dekat ekosistem menabung tropis Financial Rainforest.</p>
        </div>

        <div className="max-w-3xl mx-auto space-y-4">
          {/* FAQ 1 */}
          <details className="group bg-white/40 dark:bg-gray-900/40 backdrop-blur-md rounded-2xl border border-gray-100 dark:border-gray-800/50 p-6 [&_summary::-webkit-details-marker]:hidden cursor-pointer transition-all duration-300">
            <summary className="flex justify-between items-center gap-4 text-left font-bold text-foreground">
      ...
      <section className="relative z-10 max-w-[1800px] mx-auto px-8 sm:px-16 lg:px-24 xl:px-32 2xl:px-40 pb-24">
        <div className="relative bg-emerald-950 dark:bg-gray-900 border border-emerald-800/30 rounded-[48px] p-8 sm:p-16 text-center overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            <div className="bg-emerald-900/50 border border-emerald-800 px-4 py-1.5 rounded-full inline-flex items-center gap-2 mb-6">
              <Sparkles className="w-4 h-4 text-primary animate-pulse" />
              <span className="text-xs font-bold text-emerald-300 uppercase tracking-widest">Mulai Perjalanan Keuanganmu</span>
            </div>
            <h3 className="text-3xl sm:text-5xl font-black text-white leading-tight tracking-tight mb-6">
              Siap Membangun Ekosistem Keuangan Terbaikmu?
            </h3>
            <p className="text-emerald-200/70 text-sm sm:text-base leading-relaxed mb-10 max-w-lg mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/login"
                className="bg-primary hover:bg-emerald-500 text-white font-bold px-8 py-4 rounded-2xl text-lg hover:shadow-xl transition-all w-full sm:w-auto text-center"
              >
                Daftar Akun Sekarang
              </Link>
              <Link
                href="/demo"
                className="bg-white/10 hover:bg-white/15 text-white font-bold px-8 py-4 rounded-2xl text-lg border border-white/10 transition-all w-full sm:w-auto text-center"
              >
                Coba Demo Dulu
              </Link>
            </div>
