...
export default function DashboardPanel() {
  ...
  return (
    <div className="w-full h-full bg-slate-50 dark:bg-gray-950 flex flex-col overflow-hidden">

      {/* Right Side Header/Navbar (Fixed Top) */}
      <div className="px-8 py-6 bg-slate-50/80 dark:bg-gray-950/80 backdrop-blur-md border-b border-gray-200/50 dark:border-gray-800/50 shrink-0 z-10 flex items-center justify-center">
